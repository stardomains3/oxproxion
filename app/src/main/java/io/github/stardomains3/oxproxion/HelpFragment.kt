...
class HelpFragment : Fragment(R.layout.fragment_help) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val markdownContent = """
            ...
            *   **Notification Button**: Activates a foreground service to prevent the app from closing in the background and enables you to customize the notification in your Android system settings. (**Highly recommended as app may not work well without it!**)
